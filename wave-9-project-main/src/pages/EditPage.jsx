...
import { deleteImageFromFirebase, urlTofirebaseUrl } from '../utils/helpers';
...
const EditPage = () => {
    ...
    return (
        <form
            ...
            autoComplete="off"
        >
            <h2 className="text-2xl text-center py-4 mb-4">Edit Property</h2>
            {/* {error && (
            ...
            {/* <ImageUploaderEdit property={property} setProperty={setProperty} /> */}
            <ImageUploader
                property={property}
            ...
            <div className="flex flex-col justify-center items-center mt-10">
                ...
                <button
                    type="submit"
                    className="text-white border bg-indigo-400 hover:bg-indigo-600 p-1.5 px-3 rounded-lg cursor-pointer"
                >
                    Edit Property
                </button>
            </div>
